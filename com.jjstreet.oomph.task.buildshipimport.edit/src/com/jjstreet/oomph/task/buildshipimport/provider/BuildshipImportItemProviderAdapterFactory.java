...
import com.jjstreet.oomph.task.buildshipimport.util.BuildshipImportAdapterFactory;
    ...
    implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender
{
   ...
   * @generated
   */
  protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(BuildshipImportEditPlugin.INSTANCE,
      BuildshipImportPackage.eNS_URI);
  ...
  /**
   * This keeps track of the one adapter used for all {@link com.jjstreet.oomph.task.buildshipimport.BuildshipImportTask} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link com.jjstreet.oomph.task.buildshipimport.BuildshipImportTask}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    if (buildshipImportTaskItemProvider == null)
    {
      buildshipImportTaskItemProvider = new BuildshipImportTaskItemProvider(this);
    }

    return buildshipImportTaskItemProvider;
  }
  ...
  public void dispose()
  {
    if (buildshipImportTaskItemProvider != null)
    {
      buildshipImportTaskItemProvider.dispose();
    }
  }
  ...
  public static class BaseChildCreationExtender implements IChildCreationExtender
  {
    ...
    protected static class CreationSwitch extends BaseSwitch<Object>
    {
      ...
      {
        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, BuildshipImportFactory.eINSTANCE.createBuildshipImportTask()));
  ...
  public static class SetupChildCreationExtender implements IChildCreationExtender
  {
    ...
    protected static class CreationSwitch extends SetupSwitch<Object>
    {
      ...
      {
        newChildDescriptors
            .add(createChildParameter(SetupPackage.Literals.SETUP_TASK_CONTAINER__SETUP_TASKS, BuildshipImportFactory.eINSTANCE.createBuildshipImportTask()));
